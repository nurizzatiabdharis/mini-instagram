...
export const Arrow = styled('span', {
  ...
  return {
    ...
    variants: [
       ...
       */
      {
        props: ({ placement }: { placement: string }) => placement?.startsWith('top-'),
       ...
       */
      {
        props: ({ placement }: { placement: string }) => placement?.startsWith('bottom-'),
       ...
       */
      {
        props: ({ placement }: { placement: string }) => placement?.startsWith('left-'),
       ...
       */
      {
        props: ({ placement }: { placement: string }) => placement?.startsWith('right-'),
